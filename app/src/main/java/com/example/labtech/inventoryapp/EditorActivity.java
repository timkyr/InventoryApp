...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set onclick listener for adding books (quantity increase)
        mAddQuantityButton = (Button) findViewById(R.id.button_add_quantity);
        ...
        //set onclick listener for removing books (quantity reduce)
        mReduceQuantityButton = (Button) findViewById(R.id.button_reduce_quantity);
